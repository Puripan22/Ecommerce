            ...
            <div className="flex flex-col items-center justify-center pr-10 pt-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
              ...
              {isRegistered ? (
                ...
                <div className=" w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                  ...
                  <button
                    className=" disabled:opacity-50 inline-flex w-full items-center justify-center bg-black px-6 py-4 text-lg text-white transition-all duration-200 ease-in-out focus:shadow 
                  font-medium uppercase tracking-wide"
